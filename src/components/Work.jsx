  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-0.5">
        <div className="project-item group reveal relative grid [grid-template-columns:60px_1fr_auto] items-center gap-8 py-7 px-0 border-t border-t-[rgba(242,237,228,0.06)] cursor-none overflow-hidden before:content-[''] before:absolute before:left-0 before:top-0 before:bottom-0 before:w-0 before:bg-[rgba(200,255,0,0.04)] hover:before:w-full before:transition-all before:duration-[400ms] before:ease-[cubic-bezier(0.16,1,0.3,1)]">
          <div className="[font-family:var(--mono)] text-[11px] text-[rgba(242,237,228,0.2)]">001</div>
          <div className="relative z-[1]">
            ...
            <div className="project-desc-wrap mt-3">
              <p className="project-desc max-w-[740px] [font-family:var(--mono)] text-[12px] leading-[1.85] text-[rgba(242,237,228,0.42)]">
                <span className="block">A fully interactive 3D product interface built from scratch.</span>
                <span className="block">Not a clone - a reconstruction of how premium product experiences are engineered.</span>
                <span className="block">Integrated real-time 3D rendering using Three.js.</span>
                <span className="block">Built scroll-synced animation systems with GSAP.</span>
                <span className="block">Optimized motion and performance across devices.</span>
              </p>
            </div>
          </div>
        ...
        <div className="project-item group reveal reveal-delay-1 relative grid [grid-template-columns:60px_1fr_auto] items-center gap-8 py-7 px-0 border-t border-t-[rgba(242,237,228,0.06)] cursor-none overflow-hidden before:content-[''] before:absolute before:left-0 before:top-0 before:bottom-0 before:w-0 before:bg-[rgba(200,255,0,0.04)] hover:before:w-full before:transition-all before:duration-[400ms] before:ease-[cubic-bezier(0.16,1,0.3,1)]">
          <div className="[font-family:var(--mono)] text-[11px] text-[rgba(242,237,228,0.2)]">002</div>
          <div className="relative z-[1]">
            <div className="[font-family:var(--syne)] font-bold [font-size:clamp(22px,3vw,36px)] text-[var(--white)] mb-1.5 group-hover:text-[var(--acid)]">
              K72 Motion System
            </div>
            <div className="project-desc-wrap mt-3">
              <p className="project-desc max-w-[740px] [font-family:var(--mono)] text-[12px] leading-[1.85] text-[rgba(242,237,228,0.42)]">
                <span className="block">An animation-first frontend focused on rhythm, pacing, and feel.</span>
                <span className="block">Designed interaction states as reusable motion patterns.</span>
                <span className="block">Built modular GSAP timelines for controlled sequencing.</span>
                <span className="block">Structured components for scalable visual choreography.</span>
                <span className="block">Balanced expressiveness with performance constraints.</span>
              </p>
            </div>
          </div>
          <div className="text-2xl text-[rgba(242,237,228,0.15)] group-hover:text-[var(--acid)] group-hover:translate-x-1 group-hover:-translate-y-1">↗</div>
        ...
        <div className="project-item group reveal reveal-delay-2 relative grid [grid-template-columns:60px_1fr_auto] items-center gap-8 py-7 px-0 border-t border-t-[rgba(242,237,228,0.06)] cursor-none overflow-hidden before:content-[''] before:absolute before:left-0 before:top-0 before:bottom-0 before:w-0 before:bg-[rgba(200,255,0,0.04)] hover:before:w-full before:transition-all before:duration-[400ms] before:ease-[cubic-bezier(0.16,1,0.3,1)]">
          <div className="[font-family:var(--mono)] text-[11px] text-[rgba(242,237,228,0.2)]">003</div>
          <div className="relative z-[1]">
            <div className="[font-family:var(--syne)] font-bold [font-size:clamp(22px,3vw,36px)] text-[var(--white)] mb-1.5 group-hover:text-[var(--acid)]">
            ...
            <div className="project-desc-wrap mt-3">
              <p className="project-desc max-w-[740px] [font-family:var(--mono)] text-[12px] leading-[1.85] text-[rgba(242,237,228,0.42)]">
                <span className="block">A high-intensity landing experience translated into performant frontend code.</span>
                <span className="block">Explored cinematic transitions and interaction layering.</span>
                <span className="block">Implemented composited motion stacks with responsive behavior.</span>
                <span className="block">Refined typography and movement to match a game-like tone.</span>
                <span className="block">Maintained smooth frame pacing under heavy animation load.</span>
              </p>
            </div>
          </div>
          <div className="text-2xl text-[rgba(242,237,228,0.15)] group-hover:text-[var(--acid)] group-hover:translate-x-1 group-hover:-translate-y-1">↗</div>
