...
const Preloader = () => {
  return (
    <>
    <div className="counter absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-10 h-5 text-center z-0">
      <p className="relative block -translate-y-5">0</p>
    </div>
    </>
