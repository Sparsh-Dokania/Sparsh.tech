...
function Ticker() {
  return (
    <div
      className="group fixed top-0 left-0 right-0 z-[100] flex h-7 items-center overflow-hidden bg-[var(--acid)] transition-transform duration-300 hover:scale-[1.01] max-[768px]:h-6"
      aria-hidden="true"
      data-ui="ticker"
    >
